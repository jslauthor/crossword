...
export const useAnimatedText = (text: string | undefined, delay: number = 0) => {
    ...
    useLayoutEffect(() => {
        ...
        intervalRef.current = setInterval(async () => {
            if (i < currentTextTokens.length) {
                const updateState = (token: string) => new Promise(resolve => {
        ...
        }, randomIntFromInterval(delay * .4, delay * 1.6));
